...
public:
  ...
  bool HLT_PFMETNoMu120_PFMHTNoMu120_IDTight;        // for trigger efficiency
  bool HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_PFHT60; // for trigger efficiency
  bool HLT_PFMETNoMu140_PFMHTNoMu140_IDTight;        // for trigger efficiency
  float met, metPhi;
  ...
  float lepPfRelIso[N_MAX_LEPTONS]; // for trigger efficiency
