...
struct leptons
{
  ...
  bool passVTightIso;
  bool passVVTightIso;
  float pfRelIso; // for trigger efficiency
};
...
void llp_MuonSystem_trigger::Analyze(bool isData, int options, string outputfilename, string analysisTag)
{
  ...
  for (Long64_t jentry = 0; jentry < fChain->GetEntries(); jentry++)
  {
    ...
    MuonSystem->HLT_PFMETNoMu120_PFMHTNoMu120_IDTight = HLT_PFMETNoMu120_PFMHTNoMu120_IDTight;               // for trigger efficiency
    MuonSystem->HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_PFHT60 = HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_PFHT60; // for trigger efficiency
    MuonSystem->HLT_PFMETNoMu140_PFMHTNoMu140_IDTight = HLT_PFMETNoMu140_PFMHTNoMu140_IDTight;               // for trigger efficiency
    ...
    for (auto &tmp : Leptons)
    {
      ...
      MuonSystem->lepPfRelIso[MuonSystem->nLeptons] = tmp.pfRelIso; // for trigger efficiency
