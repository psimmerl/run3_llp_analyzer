...
void TreeMuonSystemCombination::InitVariables()
{
  ...
  HLT_PFMETNoMu120_PFMHTNoMu120_IDTight = false;        // for trigger efficiency
  HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_PFHT60 = false; // for trigger efficiency
  HLT_PFMETNoMu140_PFMHTNoMu140_IDTight = false;        // for trigger efficiency
  ...
  for (int i = 0; i < N_MAX_LEPTONS; i++)
  {
    ...
    lepPassVTightIso[i] = false;
    lepPfRelIso[i] = -999; // for trigger efficiency
  }
...
void TreeMuonSystemCombination::InitTree()
{
  ...
  tree_->SetBranchAddress("HLT_PFMETNoMu120_PFMHTNoMu120_IDTight", &HLT_PFMETNoMu120_PFMHTNoMu120_IDTight); // for trigger efficiency
  tree_->SetBranchAddress("HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_PFHT60", &HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_PFHT60); // for trigger efficiency
  tree_->SetBranchAddress("HLT_PFMETNoMu140_PFMHTNoMu140_IDTight", &HLT_PFMETNoMu140_PFMHTNoMu140_IDTight); // for trigger efficiency
  ...
  tree_->SetBranchAddress("lepPassVTightIso", lepPassVTightIso);
  tree_->SetBranchAddress("lepPfRelIso", lepPfRelIso); // for trigger efficiency
